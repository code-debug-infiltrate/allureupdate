    ...
    <section class="about-banner" style="background-image: url(/Images/Body/head.png);">
        <div class="container">
            <div class="content-box">
                ...
                <div class="text">These Terms of Service ("Terms") govern your use of our website, services, and any related content provided by Splendid Global Sports ("we," "us," or "our"). By accessing or using our services, you agree to be bound by these Terms. If you do not agree with any part of these Terms, please do not use our services.</div>
            </div>
        </div>
    </section>
    <!-- about-banner end -->
        ...
        <div class="container">
            <div class="inner-container">
                <div class="title-box">
                    ...
                    <p>2.1 Training Programs: We offer various football training programs, both online and in-person, designed to improve skills and performance. <br>2.2 Content: Our services may include videos, articles, training materials, and other content. This content is for personal use only and may not be redistributed without our permission.</p>
                    ...
                    <p>6.1 Ownership: All content provided by Splendid Global Sports, including text, graphics, logos, and videos, is owned by us or our licensors and is protected by intellectual property laws. <br>6.2 Usage: You may not reproduce, distribute, or create derivative works from our content without our explicit permission.</p>
                    <h1> 7. Limitation of Liability</h1>
                    <p>7.1 No Warranty: Our services are provided "as is" without any warranties, express or implied. <br>7.2 Liability: To the maximum extent permitted by law, Splendid Global Sports shall not be liable for any indirect, incidental, or consequential damages arising out of or in connection with the use of our services.</p>
                    <h1> 8. Termination</h1>
