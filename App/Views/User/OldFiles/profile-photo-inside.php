<div class="row">
    ...
    <div class="col-md-4 col-lg-6">
        ...
        <div class="col-md-12 center-content pull-center" style="margin-bottom: 30px;">
            ...
            <?php } else { ?>
                <center><img src="/Images/Body/passportPhoto.png" id="output_profileimage" alt="Profile Page" style="width: 200px;"></center>
            <?php } ?>
            <br>
            <form method="POST" action="" class="edit-phto" enctype="multipart/form-data"> 
                ...
                <div class="card-action message-btn" style="margin-top: 10px; margin-bottom: 20px; border-radius: 1px; width: 100%;">
