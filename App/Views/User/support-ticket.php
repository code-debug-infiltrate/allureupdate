...
<title>Support Ticket | <?php if(isset($coyInfo['coyname'])) { echo $coyInfo['coyname']; } else { echo getenv('APP_NAME'); } ?> </title>
						...
						<div class="email-wrapper">
							<div class="email-menu-bar">
								<div class="compose-mail">
									<a href="<?= baseURL('us-messages/'); ?><?= $userInfo['uniqueid']; ?>/?cat=All" class="btn-secondry add-item m-r5 mt-2"><i class="fa fa-fw fa-plus-circle"></i> Return To Messages</a>
								</div>
							...
							<div class="mail-list-container">
                                ...
                                <p class="ml-5" style="font-size: 26px;">: Raise a Support Ticket</p>
								
                                <div class="detailsError_box" style="margin:10px 0px;"></div>
                                
                                <form action="" method="POST" class="mail-compose" enctype="multipart/form-data" autocomplete="off">
									...
									<div class="form-group col-12">
										<button type="submit" id="raiseTicket" name="raiseTicket" class="btn-secondry add-item m-r5 mt-5"><i class="fa fa-fw fa-plus-circle"></i> Raise a Ticket</button>
									</div>
								</form>
