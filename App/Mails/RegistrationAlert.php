...
//Mail to Admin For new Consultation 
public function consultation_alert($data, $coyInfo)
{
    $sendMail = new Mail();
    ...
    $sendMail->from = getenv('APP_NAME');
    $sendMail->replyto = getenv('APP_EMAIL');
    $sendMail->subject = 'Therapy And Consultation Registration Details';
    // To send HTML mail, the Content-type header must be set
    $sendMail->message_body = '
        <html>
            <body>
            ...
            <h3 style="margin: 10px; text-align: center;">Therapy And Consultation Registration Details On '.getenv('APP_NAME').'</h3>

            <p style="margin: 10px; font-size: 16px;">
            Hello Admin Of '.getenv('APP_NAME').',
            <br>
            A New Application Is Ongoing For Therapy And Consultation On '.getenv('APP_NAME').'
            <br><br> 
             Membership Information Are 
            <br><br> 
            ...
            <br>  
            Preferred Contact Date: '.$data['contactdate'].'
            <br>  
            Preferred Contact Method: '.$data['contactmethod'].'
            <br>  
            Relevant Details: '.$data['message'].'
            <br><br> 
            Keep These Information Secure. If you ever feel your password has been compromised, Reset it immediately and dont forget to turn on the 2FA system on your dashboard. 
            <br><br>
            Warm Regards!
...
public function transaction_alert($buddy, $coyInfo)
{
    $sendMail = new Mail();
    ...
    $sendMail->from = getenv('APP_NAME');
    $sendMail->replyto = getenv('APP_EMAIL');
    $sendMail->subject = 'Your Payment Has Been Initiated';
    // To send HTML mail, the Content-type header must be set
    $sendMail->message_body = '
        <html>
            <body>
            ...
            <h3 style="margin: 10px;">'.$buddy['currency'].''.$buddy['amount'].' Payment By  '.$buddy['fname'].' '.$buddy['lname'].' </h3>
            <br><br>
            <p style="margin: 10px;">
            ...
            <br><br>
            <a href="'.$buddy['payment_url'].'">Complete This Payment</a> Now Or Copy This Link To Your Browser '.$buddy['payment_url'].'. 
            <br><br>
